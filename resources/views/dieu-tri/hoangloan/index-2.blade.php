            ...
            <form class="mt-3 ml-5 mr-5" action="{{route('view.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row ml-5">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" id="kd20" type="checkbox" onchange="chkChange('20');">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" id="kd14" type="checkbox" onchange="chkChange('14');">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="mb-0">
                                ...
                                <input name="" class="form-control-smt" id="kd21" type="text" onblur="txtBlur('21');">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="mb-0">
