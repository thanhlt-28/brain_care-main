...
<div class="container-wraper">
    <script type="text/javascript">
        ...
        function xulythuoc() {
            ...
            document.getElementById('0116').innerHTML = Math.max(k0111, k0112, k0113, k0114);
            ...
            document.getElementById('0216').innerHTML = Math.max(k0211, k0212, k0213, k0214);
            ...
            document.getElementById('0316').innerHTML = Math.max(k0311, k0312, k0313, k0314);

            document.getElementById('0411').innerHTML = (kd[01] == 0 ? 0 : 2);
            document.getElementById('0412').innerHTML = (kd[02] == 0 ? 0 : 2);
            document.getElementById('0413').innerHTML = (kd[03] == 0 ? 0 : 1);
            ...
            document.getElementById('0416').innerHTML = Math.max(k0411, k0412, k0413, k0414);
            ...
            document.getElementById('0516').innerHTML = Math.max(k0511, k0512, k0513, k0514);
            ...
            document.getElementById('0616').innerHTML = Math.max(k0611, k0612, k0613, k0614);
            ...
            document.getElementById('0716').innerHTML = Math.max(k0711, k0712, k0713, k0714);
            ...
            document.getElementById('0816').innerHTML = Math.max(k0811, k0812, k0813, k0814);
            ...
            document.getElementById('0823').innerHTML = (kd[10] == 0 ? 0 : 4);
            ...
            document.getElementById('0732').innerHTML = (kd[17] == 0 ? 0 : 5);
            ...
            document.getElementById('kd21').value = kd[6] + kd[7] + kd[18] + kd[19] + kd[14] + kd[15] + kd[5] + kd[13];
            if ((kd[6] + kd[7] + kd[18] + kd[19] + kd[14] + kd[15] + kd[5] + kd[13]) == 0)
                document.getElementById('kd22').value = "Thuyên giảm";
            if ((kd[6] + kd[7] + kd[18] + kd[19] + kd[14] + kd[15] + kd[5] + kd[13]) >= 4)
                document.getElementById('kd22').value = "Không thuyên giảm";
            if ((kd[6] + kd[7] + kd[18] + kd[19] + kd[14] + kd[15] + kd[5] + kd[13]) > 0 && (kd[6] + kd[7] + kd[18] + kd[19] + kd[14] + kd[15] + kd[5] + kd[13]) < 4)
                document.getElementById('kd22').value = "Thuyên giảm một phần";
            if ((kd[6] + kd[7] + kd[18] + kd[19] + kd[14] + kd[15] + kd[5] + kd[13]) <= 3)
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="tab0" role="tabpanel" aria-labelledby="home-tab">
            <form class="mt-3 ml-5 mr-5" action="{{route('hoangloan.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <h5>Thông tin
                        <!-- <hr width="10%"> -->
                ...
                <div class="row ml-5">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd02" type="checkbox" name="symptom[]" value="hlhl" onchange="chkChange('02');">
                            <label for="">Hoảng loạn</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd03" type="checkbox" name="symptom[]" value="nguithl" onchange="chkChange('03');">
                            <label for="">Ngủ ít</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd07" type="checkbox" name="symptom[]" value="timhoihop" onchange="chkChange('07');">
                            <label for="">Tim hồi hộp</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd08" type="checkbox" name="symptom[]" value="khotho" onchange="chkChange('08');">
                            <label for="">Khó thở</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd19" type="checkbox" name="symptom[]" value="daunguc" onchange="chkChange('19');">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd16" type="checkbox" name="symptom[]" value="techantay" onchange="chkChange('16');">
                            <label for="">Tê chân tay</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd06" type="checkbox" name="symptom[]" value="sochet" onchange="chkChange('06');">
                            <label for="">Sợ chết</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd04" type="checkbox" name="symptom[]" value="tchl" onchange="chkChange('04');">
                            <label for="">Tình cảm</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd05" type="checkbox" name="symptom[]" value="loauhl" onchange="chkChange('05');">
                            <label for="">Lo âu</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd20" type="checkbox" name="symptom[]" value="daubung" onchange="chkChange('20');">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd11" type="checkbox" name="symptom[]" value="tmhl" onchange="chkChange('11');">
                            <label for="">Tim mạch</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd15" type="checkbox" name="symptom[]" value="runhl" onchange="chkChange('15');">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" id="kd17" type="checkbox" name="symptom[]" value="tdhl" onchange="chkChange('17');">
                            <label for="">Tình dục</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd18" type="checkbox" name="symptom[]" value="thaihl" onchange="chkChange('18');">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd12" type="checkbox" name="symptom[]" value="dtdhl" onchange="chkChange('12');">
                            <label for="">Đái tháo đường</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd14" type="checkbox" name="symptom[]" value="smks" onchange="chkChange('14');">
                            <label for="">Sợ mất kiểm soát</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd09" type="checkbox" name="symptom[]" value="hathaphl" onchange="chkChange('09');">
                            <label for="">Huyết áp thấp</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd10" type="checkbox" name="symptom[]" value="hacaohl" onchange="chkChange('10');">
