...
<div class="container-page">
    ...
    <table class="table table-success table-striped table-bordered mt-3 mb-3" border="1" cellspacing="0" cellpadding="2">
        <h3 class="mx-auto mt-3 font-weight-bold">Thuốc Điều Trị Ám Ảnh</h3>
        <thead>
            <tr>
                <th>STT</th>
                <th>Loại</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>C Trầm cảm</td>
                <td id="dt">CTC khác</td>
                <td id="dt">Bupropion</td>
                <td id="dt">Welbutrin (150mg)</td>
                <td id="dt">150 mg</td>
                <td id="dt">300 mg</td>
                <td id="dt">GlaxoSmithKline</td>
                <td id="dt">Anh</td>
            </tr>
    </table>
</div>
