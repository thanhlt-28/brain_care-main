...
<div class="container-wraper">
    <script type="text/javascript">
        ...
        function xulythuoc() {
            ...
            document.getElementById('0112').innerHTML = (kd[02] == 0 ? 0 : 5);
            document.getElementById('kb2').innerHTML = (kd[02] == 0 ? 0 : 1);
            document.getElementById('0113').innerHTML = (kd[03] == 0 ? 0 : 4);
            document.getElementById('kb3').innerHTML = (kd[03] == 0 ? 0 : 1);
            document.getElementById('0114').innerHTML = (kd[04] == 0 ? 0 : 4);
            document.getElementById('kb4').innerHTML = (kd[04] == 0 ? 0 : 1);
            document.getElementById('0115').innerHTML = (kd[05] == 0 ? 0 : 3);
            ...
            document.getElementById('0312').innerHTML = (kd[02] == 0 ? 0 : 4);
            document.getElementById('0313').innerHTML = (kd[03] == 0 ? 0 : 4);
            document.getElementById('0314').innerHTML = (kd[04] == 0 ? 0 : 4);
            document.getElementById('0315').innerHTML = (kd[05] == 0 ? 0 : 3);
            ...
            document.getElementById('0411').innerHTML = (kd[01] == 0 ? 0 : 2);
            ...
            document.getElementById('0612').innerHTML = (kd[02] == 0 ? 0 : 1);
            ...
            document.getElementById('0712').innerHTML = (kd[02] == 0 ? 0 : 2);
            document.getElementById('0713').innerHTML = (kd[03] == 0 ? 0 : 1);
            ...
            document.getElementById('0812').innerHTML = (kd[02] == 0 ? 0 : 2);
            document.getElementById('0813').innerHTML = (kd[03] == 0 ? 0 : 1);
            ...
            document.getElementById('0122').innerHTML = (kd[09] == 0 ? 0 : 4);
            ...
            document.getElementById('0232').innerHTML = (kd[17] == 0 ? 0 : 5);
            ...
            document.getElementById('0432').innerHTML = (kd[17] == 0 ? 0 : 5);
            ...
            document.getElementById('0632').innerHTML = (kd[17] == 0 ? 0 : 5);
            ...
            document.getElementById('0832').innerHTML = (kd[17] == 0 ? 0 : 4);
            ...
            var n = kd[06] + kd[07] + kd[14] + kd[15] + kd[26];
            ...
            document.getElementById('kd25').value = kd[03];
    ...
    <div class="container-fluid">
        ...
        <div class="content-tabs">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="home-tab" data-bs-toggle="tab" data-bs-target="#tab1" type="button" role="tab" aria-controls="home" aria-selected="true">Rối loạn tâm thần</button>
                </li>
                <li class="nav-item" role="presentation">
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="tab0" role="tabpanel" aria-labelledby="home-tab">
            <form class="mt-3 ml-5 mr-5" action="{{route('nghienruou.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <h5>Thông tin
                        <!-- <hr width="10%"> -->
                ...
                <div class="row ml-1">
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd02" type="checkbox" name="symptom[]" value="nr" onchange="chkChange('02');">
                            <label for="">Nghiện rượu</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd07" type="checkbox" name="symptom[]" value="unr" onchange="chkChange('07');">
                            <label for="">Uống nhiều rượu</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd08" type="checkbox" name="symptom[]" value="cktc" onchange="chkChange('08');">
                            <label for="cktc">Cai không thành công</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd15" type="checkbox" name="symptom[]" value="tur" onchange="chkChange('15');">
                            <label for="">Thèm uống rượu</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd16" type="checkbox" name="symptom[]" value="ahsh" onchange="chkChange('16');">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd17" type="checkbox" name="symptom[]" value="hvnh" onchange="chkChange('17');">
                            <label for="">Hành vi nguy hiểm</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd03" type="checkbox" name="symptom[]" value="tc" onchange="chkChange('03');">
                            <label for="">Tình cảm</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd04" type="checkbox" name="symptom[]" value="lt" onchange="chkChange('04');">
                            <label for="">Loạn thần</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd05" type="checkbox" name="symptom[]" value="la" onchange="chkChange('05');">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd06" type="checkbox" name="symptom[]" value="hl" onchange="chkChange('06');">
                            <label for="">Hoảng loạn</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd09" type="checkbox" name="symptom[]" value="hathap" onchange="chkChange('09');">
                            <label for="">Huyết áp thấp</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd10" type="checkbox" name="symptom[]" value="hacao" onchange="chkChange('10');">
                            <label for="">Huyết áp cao</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd11" type="checkbox" name="symptom[]" value="tm" onchange="chkChange('11');">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd12" type="checkbox" name="symptom[]" value="dtd" onchange="chkChange('12');">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" id="kd17" type="checkbox" name="symptom[]" value="td" onchange="chkChange('17');">
                            <label for="">Tình dục</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd18" type="checkbox" name="symptom[]" value="thai" onchange="chkChange('18');">
                ...
                <div class="row ml-1">
                    ...
                    <div class="col-md-2">
                        <div class="mb-3">
                            ...
                            <input style="color: blue; font-weight:500" class="form-control-smt" name="result" id="kd22" type="text" onblur="txtBlur('22');" width="10">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-3">
        ...
        <div class="tab-pane fade ml-5" id="tab1" role="tabpanel" aria-labelledby="home-tab">
            ...
            <table class="table table-bordered border-primary" id="tt" border="1">
                ...
                <tbody>
                    ...
                    <td>{{$index++}}</td>
                    <td>Naltrexone</td>
                    <td style="text-align:center;"><b>ĐT</b></td>
                    <td id="0111">0
                    <td id="0112">0
                    <td id="0113">0
                    <td id="0114">0</td>
        ...
        <div class="tab-pane fade ml-5" id="tab2" role="tabpanel" aria-labelledby="home-tab">
            <h4>Bệnh cơ thể</h4>
            <table class="table table-bordered border-primary" id="tt" border="1">
                <thead>
                    <th>STT</th>
        ...
        <div class="tab-pane fade ml-5" id="tab3" role="tabpanel" aria-labelledby="home-tab">
            <h4>Đặc điểm</h4>
            <table class="table table-bordered border-primary" id="tt" border="1">
                <thead>
                    <tr>
        ...
        <div class="tab-pane fade ml-5" id="tab4" role="tabpanel" aria-labelledby="home-tab">
            <h4>Tổng hợp</h4>
            <table class="table table-bordered border-primary" id="tt" border="1">
                <thead>
                    <th>STT</th>
