...
<div class="container-wraper">
    ...
    <script type="text/javascript">
        ...
        function xulythuoc() {
            ...
            document.getElementById('0112').innerHTML = (kd[02] == 0 ? 0 : 3);
            ...
            document.getElementById('0115').innerHTML = (kd[05] == 0 ? 0 : 4);
            ...
            document.getElementById('0215').innerHTML = (kd[05] == 0 ? 0 : 3);
            ...
            document.getElementById('0312').innerHTML = (kd[02] == 0 ? 0 : 3);
            ...
            document.getElementById('0415').innerHTML = (kd[05] == 0 ? 0 : 4);
            ...
            document.getElementById('0511').innerHTML = (kd[01] == 0 ? 0 : 4);
            document.getElementById('0512').innerHTML = (kd[02] == 0 ? 0 : 4);
            ...
            document.getElementById('0714').innerHTML = (kd[04] == 0 ? 0 : 2);
            ...
            document.getElementById('0813').innerHTML = (kd[03] == 0 ? 0 : 4);
            ...
            document.getElementById('0122').innerHTML = (kd[09] == 0 ? 0 : 5);
            document.getElementById('ct2').innerHTML = (kd[09] == 0 ? 0 : 1);
            document.getElementById('0123').innerHTML = (kd[10] == 0 ? 0 : 5);
            ...
            document.getElementById('0222').innerHTML = (kd[09] == 0 ? 0 : 5);
            document.getElementById('0223').innerHTML = (kd[10] == 0 ? 0 : 3);
            document.getElementById('0224').innerHTML = (kd[11] == 0 ? 0 : 3);
            document.getElementById('0225').innerHTML = (kd[12] == 0 ? 0 : 5);
            ...
            document.getElementById('0322').innerHTML = (kd[09] == 0 ? 0 : 4);
            ...
            document.getElementById('0422').innerHTML = (kd[09] == 0 ? 0 : 5);
            document.getElementById('0423').innerHTML = (kd[10] == 0 ? 0 : 5);
            ...
            document.getElementById('0621').innerHTML = (kd[08] == 0 ? 0 : 4);
            ...
            document.getElementById('0131').innerHTML = (kd[16] == 0 ? 0 : 2);
            document.getElementById('sh1').innerHTML = (kd[16] == 0 ? 0 : 1);
            var k0131 = parseInt(document.getElementById('0131').innerHTML);
            document.getElementById('0135').innerHTML = Math.max(k0131);

            document.getElementById('0231').innerHTML = (kd[16] == 0 ? 0 : 2);
            var k0231 = parseInt(document.getElementById('0231').innerHTML);
            document.getElementById('0235').innerHTML = Math.max(k0231);

            document.getElementById('0331').innerHTML = (kd[16] == 0 ? 0 : 2);
            var k0331 = parseInt(document.getElementById('0331').innerHTML);
            document.getElementById('0335').innerHTML = Math.max(k0331);

            document.getElementById('0431').innerHTML = (kd[16] == 0 ? 0 : 3);
            var k0431 = parseInt(document.getElementById('0431').innerHTML);
            document.getElementById('0435').innerHTML = Math.max(k0431);

            document.getElementById('0531').innerHTML = (kd[16] == 0 ? 0 : 5);
            var k0531 = parseInt(document.getElementById('0531').innerHTML);
            document.getElementById('0535').innerHTML = Math.max(k0531);

            document.getElementById('0631').innerHTML = (kd[16] == 0 ? 0 : 4);
            var k0631 = parseInt(document.getElementById('0631').innerHTML);
            document.getElementById('0635').innerHTML = Math.max(k0631);

            document.getElementById('0731').innerHTML = (kd[16] == 0 ? 0 : 4);
            var k0731 = parseInt(document.getElementById('0731').innerHTML);
            document.getElementById('0735').innerHTML = Math.max(k0731);

            document.getElementById('0831').innerHTML = (kd[16] == 0 ? 0 : 3);
            var k0831 = parseInt(document.getElementById('0831').innerHTML);
            document.getElementById('0835').innerHTML = Math.max(k0831);
            ...
            document.getElementById('kd20').value = kd[3] + kd[6] + kd[7] + kd[14] + kd[15];
            if ((kd[3] + kd[6] + kd[7] + kd[14] + kd[15]) == 0)
                document.getElementById('kd21').value = "Thuyên giảm";
            if ((kd[3] + kd[6] + kd[7] + kd[14] + kd[15]) == 2)
                document.getElementById('kd21').value = "Không thuyên giảm";
            if ((kd[3] + kd[6] + kd[7] + kd[14] + kd[15]) > 0 && (kd[3] + kd[6] + kd[7] + kd[14] + kd[15]) < 2)
                document.getElementById('kd21').value = "Thuyên giảm một phần";
            document.getElementById('kd22').value = kd[01];
            document.getElementById('kd23').value = kd[02];
            document.getElementById('kd24').value = kd[04];
            document.getElementById('kd25').value = kd[05];
            document.getElementById('kd18').value = kd[05];
        }
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="tab0" role="tabpanel" aria-labelledby="home-tab">
            <form class="mt-3 ml-5 mr-5" action="{{route('mattri.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <h5>Thông tin
                        <!-- <hr width="10%"> -->
                        ...
                        <div class="col">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="col-md-12">
                                        <div class="form-check">
                                            <input class="form-check-input" id="kd02" type="checkbox" name="symptom[]" value="alznhe" onchange="chkChange('02');">
                                            <label for="">Alzheimer nhẹ</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="kd03" type="checkbox" name="symptom[]" value="alznang" onchange="chkChange('03');">
                                            <label for="">Alzheimer nặng</label>
                                        </div>
                                        <div class=" form-check">
                                            <input class="form-check-input" id="kd04" type="checkbox" name="symptom[]" value="nguitmt" onchange="chkChange('04');">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check">
                                            <input class="form-check-input" id="kd05" type="checkbox" name="symptom[]" value="tcmt" onchange="chkChange('05');">
                                            <label for="">Tình cảm</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="kd06" type="checkbox" name="symptom[]" value="ltmt" onchange="chkChange('06');">
                                            <label for="">Loạn thần</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="kd11" type="checkbox" name="symptom[]" value="tmmt" onchange="chkChange('11');">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check">
                                            <input class="form-check-input" id="kd08" type="checkbox" name="symptom[]" value="2dovat" onchange="chkChange('08');">
                                            <label for="">2 đồ vật đơn giản</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="kd15" type="checkbox" name="symptom[]" value="3dovat" onchange="chkChange('15');">
                                            <label for="">Gọi tên 3 đồ vật</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="kd12" type="checkbox" name="symptom[]" value="dtdmt" onchange="chkChange('12');">
                        ...
                        <div class="col">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check">
                                            <input class="form-check-input" id="kd09" type="checkbox" name="symptom[]" value="hathapmt" onchange="chkChange('09');">
                                            <label for="">Huyết áp thấp</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="kd10" type="checkbox" name="symptom[]" value="hacaomt" onchange="chkChange('10');">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check">
                                            <input class="form-check-input" id="kd17" type="checkbox" name="symptom[]" value="beophimt" onchange="chkChange('17');">
                                            <label for="">Béo phì</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="kd07" type="checkbox" name="symptom[]" value="danhvannguoc" onchange="chkChange('07');">
                                            <label for="">Đánh vần ngược</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" id="kd16" type="checkbox" name="symptom[]" value="vhggv1c" onchange="chkChange('16');">
                                ...
                                <div class="col-md-4">
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control-smt" value="tdt" id="kd22" type="text" width="10">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row ml-1">
                    <div class="col-md-2">
                        <div class="mb-0">
                            ...
                            <input name="sym_time" class="form-control-smt" id="kd20" value="sym_time" type="text" onblur="txtBlur('21');">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-0">
                            <label class="form-label-dt" for="">Thuyên giảm</label>
                            <input class="form-control-smt" id="kd21" type="text" name="result" value="result" onblur="txtBlur('22');" width="10">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-0">
                            <label class="form-label-dt" for="">Memantine</label>
                            <input class="form-control-smt" name="medicine_once" id="kd23" type="text" width="10">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-0">
                            <label class="form-label-dt" for="">Chống co giật</label>
                            <input class="form-control-smt" name="medicine_twice" id="kd18" type="text" width="10">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-0">
                            <label class="form-label-dt" for="">Chống trầm cảm</label>
                            <input class="form-control-smt" name="medicine_three" id="kd24" type="text" width="10">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="mb-0">
                            <label class="form-label-dt" for="">Chống loạn thần</label>
                            <input class="form-control-smt" name="medicine_fourth" id="kd25" type="text" width="10">
                        </div>
                    </div>
                </div>
