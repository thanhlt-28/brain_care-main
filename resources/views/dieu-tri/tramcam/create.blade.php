...
<div class="container-wraper">
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="tab0" role="tabpanel" aria-labelledby="home-tab">
            <form class="mt-3 ml-5 mr-5" action="{{route('tramcam.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <h5>Thông tin
                        <!-- <hr width="10%"> -->
                ...
                <div class="row ml-1">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-0 form-check">
                            <input class="form-check-input" id="kd16" type="checkbox" name="symptom[]" value="chamchap" onchange="chkChange('16');">
                            <label for="">Chậm chạp</label>
                        </div>
                        <div class="mb-0 form-check">
                            <input class="form-check-input" id="kd14" type="checkbox" name="symptom[]" value="biquan" onchange="chkChange('14');">
                            <label for="">Bi quan</label>
                        </div>
                        <div class="mb-0 form-check">
                            <input class="form-check-input" id="kd19" type="checkbox" name="symptom[]" value="anit" onchange="chkChange('19');">
                            <label for="">Ăn ít</label>
                        </div>
                        <div class="mb-0 form-check">
                            <input class="form-check-input" id="kd05" type="checkbox" name="symptom[]" value="loanthan" onchange="chkChange('05');">
                    ...
                    <div class="col-md-3">
                        <div class="mb-0 form-check">
                            <input class="form-check-input" id="kd06" type="checkbox" name="symptom[]" value="loau" onchange="chkChange('06');">
                        ...
                        <div class="mb-0 form-check">
                            <input class="form-check-input" id="kd11" type="checkbox" name="symptom[]" value="timmach" onchange="chkChange('11');">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-0 form-check">
                            <input class="form-check-input" id="kd17" type="checkbox" name="symptom[]" value="tinhduc" onchange="chkChange('17');">
        ...
        <div class="tab-pane ml-5 fade" id="tab1" role="tabpanel" aria-labelledby="home-tab">
            ...
            <table class="table table-bordered border-primary" id="tt" border="1">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align:center;"><b>Buồn</b></td>
                        <td style="text-align:center;"><b>Ngủ ít</b></td>
                        <td style="text-align:center;"><b>Tự tử</b></td>
                        <td style="text-align:center;"><b>Loạn thần</b></td>
                        <td style="text-align:center;"><b>Lo âu</b></td>
                        <td style="text-align:center;"><b>Lâm sàng</b></td>
                    </tr>
                    <tr>
                        <td>{{$index++}}</td>
                        <td>Khám bệnh</td>
