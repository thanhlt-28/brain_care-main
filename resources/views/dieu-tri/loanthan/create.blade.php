...
<div class="container-wraper">
    <script type="text/javascript">
        ...
        function xulythuoc() {
            ...
            document.getElementById('0212').innerHTML = (kd[02] == 0 ? 0 : 2);
            document.getElementById('0213').innerHTML = (kd[03] == 0 ? 0 : 2);
            document.getElementById('0214').innerHTML = (kd[04] == 0 ? 0 : 2);
            ...
            document.getElementById('0313').innerHTML = (kd[03] == 0 ? 0 : 2);
            ...
            document.getElementById('0515').innerHTML = (kd[05] == 0 ? 0 : 3);
            ...
            document.getElementById('0714').innerHTML = (kd[04] == 0 ? 0 : 4);
            ...
            document.getElementById('0121').innerHTML = (kd[08] == 0 ? 0 : 5);
            ...
            document.getElementById('0124').innerHTML = (kd[11] == 0 ? 0 : 5);
            ...
            document.getElementById('0224').innerHTML = (kd[11] == 0 ? 0 : 4);
            document.getElementById('0225').innerHTML = (kd[12] == 0 ? 0 : 4);
            ...
            document.getElementById('0324').innerHTML = (kd[11] == 0 ? 0 : 5);
            ...
            document.getElementById('0521').innerHTML = (kd[08] == 0 ? 0 : 5);
            ...
            document.getElementById('0625').innerHTML = (kd[12] == 0 ? 0 : 5);
            ...
            document.getElementById('0131').innerHTML = (kd[16] == 0 ? 0 : 5);
            ...
            document.getElementById('0331').innerHTML = (kd[16] == 0 ? 0 : 5);
            document.getElementById('0332').innerHTML = (kd[17] == 0 ? 0 : 3);
            document.getElementById('0333').innerHTML = (kd[18] == 0 ? 0 : 3);
            ...
            document.getElementById('0433').innerHTML = (kd[18] == 0 ? 0 : 4);
            ...
            document.getElementById('0633').innerHTML = (kd[18] == 0 ? 0 : 4);
            ...
            document.getElementById('0733').innerHTML = (kd[18] == 0 ? 0 : 5);
            ...
            var n = kd[01] + kd[02] + kd[06]
            document.getElementById('kd21').value = n;
            if (n >= 2) {
                document.getElementById('kd22').value = "GĐ cấp tính";
            } else {
                if (n == 0) {
                    document.getElementById('kd22').value = "GĐ ổn định";
                } else {
                    document.getElementById('kd22').value = "GĐ đang ổn định";
                }
            }
            if (n >= 2) {
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="tab0" role="tabpanel" aria-labelledby="home-tab">
            <form class="mt-3 ml-5 mr-5" action="{{route('loanthan.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <h5>Thông tin
                        <!-- <hr width="10%"> -->
                ...
                <div class="row ml-5">
                    <div class="col-md-2 ml-3">
                        <div class=" form-check">
                            <input class="form-check-input" id="kd02" type="checkbox" name="symptom[]" value="dtlt" onchange="chkChange('02');">
                            <label for="">Dương tính</label>
                        </div>
                        <div class=" form-check">
                            <input class="form-check-input" id="kd03" type="checkbox" name="symptom[]" value="atlt" onchange="chkChange('03');">
                            <label for="">Âm tính</label>
                        </div>
                        <div class=" form-check">
                            <input class="form-check-input" id="kd04" type="checkbox" name="symptom[]" value="bluclt" onchange="chkChange('04');">
                    ...
                    <div class="col-md-2 ml-3">
                        <div class=" form-check">
                            <input class="form-check-input" id="kd05" type="checkbox" name="symptom[]" value="tutult" onchange="chkChange('05');">
                            <label for="">Tự tử</label>
                        </div>
                        <div class=" form-check">
                            <input class="form-check-input" id="kd06" type="checkbox" name="symptom[]" value="tclt" onchange="chkChange('06');">
                            <label for="">Trầm cảm</label>
                        </div>
                        <div class=" form-check">
                            <input class="form-check-input" id="kd07" type="checkbox" name="symptom[]" value="vtclt" onchange="chkChange('07');">
                    ...
                    <div class="col-md-2 ml-3">
                        <div class=" form-check">
                            <input class="form-check-input" id="kd09" type="checkbox" name="symptom[]" value="hathaplt" onchange="chkChange('09');">
                            <label for="">Huyết áp thấp</label>
                        </div>
                        <div class=" form-check">
                            <input class="form-check-input" id="kd10" type="checkbox" name="symptom[]" value="hacaolt" onchange="chkChange('10');">
                            <label for="">Huyết áp cao</label>
                        </div>
                        <div class=" form-check">
                            <input class="form-check-input" id="kd11" type="checkbox" name="symptom[]" value="tmlt" onchange="chkChange('11');">
                    ...
                    <div class="col-md-2 ml-3">
                        <div class=" form-check">
                            <input class="form-check-input" id="kd12" type="checkbox" name="symptom[]" value="dtdlt" onchange="chkChange('12');">
                            <label for="">Đái tháo đường</label>
                        </div>
                        <div class=" form-check">
                            <input class="form-check-input" id="kd13" type="checkbox" name="symptom[]" value="parkison" onchange="chkChange('13');">
                            <label for="">Parkinson</label>
                        </div>
                        <div class=" form-check">
                            <input class="form-check-input" id="kd17" type="checkbox" name="symptom[]" value="beophilt" onchange="chkChange('17');">
                    ...
                    <div class="col-md-2 ml-3">
                        <div class=" form-check">
                            <input class="form-check-input" id="kd18" type="checkbox" name="symptom[]" value="tdlt" onchange="chkChange('18');">
                            <label for="">Tình dục</label>
                        </div>
                        <div class=" form-check">
                            <input class="form-check-input" id="kd19" type="checkbox" name="symptom[]" value="thailt" onchange="chkChange('19');">
        ...
        <div class="tab-pane fade ml-5" id="tab3" role="tabpanel" aria-labelledby="messages-tab">
            <h3>Đặc điểm</h3>
            <table class="table table-bordered border-primary" id="tt" border="1">
                <thead>
                    <tr>
        ...
        <div class="tab-pane fade ml-5" id="tab4" role="tabpanel" aria-labelledby="settings-tab">
            <h3>Tổng hợp</h3>
            <table class="table table-bordered border-primary" id="tt" border="1">
                <thead>
                    <th>STT</th>
