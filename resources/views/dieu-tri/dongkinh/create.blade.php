                ...
                <div class="row ml-5">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd04" type="checkbox" name="symptom[]" value="baolucdk" onchange="chkChange('04');">
                            <label for="">Bạo lực</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd05" type="checkbox" name="symptom[]" value="tcdk" onchange="chkChange('05');">
                            <label for="">Tình cảm</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd06" type="checkbox" name="symptom[]" value="loanthandk" onchange="chkChange('06');">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd09" type="checkbox" name="symptom[]" value="hathapdk" onchange="chkChange('09');">
                            <label for="">Huyết áp thấp</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd10" type="checkbox" name="symptom[]" value="hacaodk" onchange="chkChange('10');">
                            <label for="">Huyết áp cao</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd11" type="checkbox" name="symptom[]" value="tmdk" onchange="chkChange('11');">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd17" type="checkbox" name="symptom[]" value="beophidk" onchange="chkChange('17');">
                            <label for="">Béo phì</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd18" type="checkbox" name="symptom[]" value="tinhducdk" onchange="chkChange('18');">
                            <label for="">Tình dục</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd19" type="checkbox" name="symptom[]" value="thaidk" onchange="chkChange('19');">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" id="kd02" type="checkbox" name="symptom[]" value="cogtp" onchange="chkChange('02');">
                            <label for="">Co giật từng phần</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd03" type="checkbox" name="symptom[]" value="cogtt" onchange="chkChange('03');">
                            <label for="">Co giật toàn thể</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd12" type="checkbox" name="symptom[]" value="dtddk" onchange="chkChange('12');">
                    ...
                    <div class="row ml-1">
                        <div class="col-md-3">
                            <div class="">
                                ...
                                <input type="text" name="sym_time" placeholder="Tính theo ngày" class="form-control-smt" id="kd07" onblur="txtBlur('07');">
                            </div>
                        </div>
                        <!-- <div class="col-md-3">
                            <div class="">
                                <label class="form-label-dt" for="">Thuyên giảm</label>
                                <input class="form-control-smt" name="result" id="kd22" value="0" type="text" onblur="txtBlur('22');" width="10">
                            </div>
                        </div> -->
                        <div class="col-md-3">
                            <div class="">
