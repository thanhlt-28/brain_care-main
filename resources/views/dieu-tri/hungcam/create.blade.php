                ...
                <div class="row ml-5">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd02" name="symptom[]" value="vv" type="checkbox" onchange="chkChange('02');">
                            <label for="">Vui vẻ</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd03" name="symptom[]" value="bl" type="checkbox" onchange="chkChange('03');">
                            <label for="">Bạo lực</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd04" name="symptom[]" value="tutuhc" type="checkbox" onchange="chkChange('04');">
                            <label for="">Tự tử</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd07" name="symptom[]" value="dnthc" type="checkbox" onchange="chkChange('07');">
                            <label for="">Dễ nóng tính</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd08" name="symptom[]" value="tucao" type="checkbox" onchange="chkChange('08');">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd27" name="symptom[]" value="dangtri" type="checkbox" onchange="chkChange('27');">
                            <label for="">Đãng trí</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd05" name="symptom[]" value="lthc" type="checkbox" onchange="chkChange('05');">
                            <label for="">Loạn thần</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd06" name="symptom[]" value="tchc" type="checkbox" onchange="chkChange('06');">
                            <label for="">Tình cảm</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd09" name="symptom[]" value="hacaohc" type="checkbox" onchange="chkChange('09');">
                            <label for="">Huyết áp cao</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd10" name="symptom[]" value="timmachhc" type="checkbox" onchange="chkChange('10');">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd18" name="symptom[]" value="tdhc" type="checkbox" onchange="chkChange('18');">
                            <label for="">Tình dục</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd18" name="symptom[]" value="thaihc" type="checkbox" onchange="chkChange('19');">
                            <label for="">Thai</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd28" name="symptom[]" value="gthd" type="checkbox" onchange="chkChange('28');">
                            <label for="">Gia tăng hoạt động</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd14" name="symptom[]" value="hvnhhc" type="checkbox" onchange="chkChange('14');">
                            <label for="">Hành vi nguy hiểm</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd15" name="symptom[]" value="gncn" type="checkbox" onchange="chkChange('15');">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd16" name="symptom[]" value="noinhieu" type="checkbox" onchange="chkChange('16');">
                            <label for="">Nói nhiều</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd11" name="symptom[]" value="parkinson" type="checkbox" onchange="chkChange('11');">
                            <label for="">Parkinson</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd12" name="symptom[]" value="dongkinh" type="checkbox" onchange="chkChange('12');">
                            <label for="">Động kinh</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd13" name="symptom[]" value="dtdhc" type="checkbox" onchange="chkChange('13');">
                            <label for="">Đái tháo đường</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd17" name="symptom[]" value="beophihc" type="checkbox" onchange="chkChange('17');">
