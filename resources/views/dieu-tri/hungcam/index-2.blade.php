            ...
            <div class="tab-pane fade show active" id="tab0" role="tabpanel" aria-labelledby="home-tab">
                ...
                <form class="mt-3 ml-5 mr-5" action="{{route('tram-cam.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row ml-5">
                        ...
                        <div class="col-md-3">
                            <div class="form-check">
                                <input class="form-check-input" id="kd27" name="ĐT" type="checkbox" onchange="chkChange('27');">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" id="kd28" name="THĐ" type="checkbox" onchange="chkChange('28');">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" id="kd12" name="ĐK" type="checkbox" onchange="chkChange('12');">
                                <label for="">Động kinh</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" id="kd13" name="ĐTĐ" type="checkbox" onchange="chkChange('13');">
