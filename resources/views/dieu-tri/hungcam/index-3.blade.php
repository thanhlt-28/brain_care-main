...
<div class="container-page">
    ...
    <table class="table table-success table-striped table-bordered mt-3 mb-3" border="1" cellspacing="0" cellpadding="2">
        <h3 class="mx-auto mt-3 font-weight-bold">Thuốc Điều Trị Hưng Cảm</h3>
        <thead>
            <tr>
                <th>STT</th>
                <th>Loại</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>C co giật</td>
                <td id="dt"></td>
                <td id="dt">Lamotrigine</td>
                <td id="dt">Lamictal (25mg)</td>
                <td id="dt">25 mg</td>
                <td id="dt">100-200 mg</td>
                <td id="dt">Glaxo smith kline</td>
                <td id="dt">Anh</td>
            </tr>
            <tr>
                <th>{{$index++}}</td>
