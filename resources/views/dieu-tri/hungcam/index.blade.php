...
<div class="container-wraper">
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="tab0" role="tabpanel" aria-labelledby="home-tab">
            <form class="mt-3 ml-5 mr-5" action="{{route('hungcam.updated', $model->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <h5>Thông tin
                        <!-- <hr width="10%"> -->
                ...
                <div class="row ml-5">
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd02" name="symptom[]" value="vv" type="checkbox" onchange="chkChange('02');" @if (strpos($model->symptom[0], 'vv') !== false)
                            checked
                            @endif>
                            <label for="">Vui vẻ</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd03" name="symptom[]" value="bl" type="checkbox" onchange="chkChange('03');" @if (strpos($model->symptom[0], 'bl') !== false)
                            checked
                            @endif>
                            <label for="">Bạo lực</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd04" name="symptom[]" value="tutuhc" type="checkbox" onchange="chkChange('04');" @if (strpos($model->symptom[0], 'tutuhc') !== false)
                            checked
                            @endif>
                            <label for="">Tự tử</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd07" name="symptom[]" value="dnthc" type="checkbox" onchange="chkChange('07');" @if (strpos($model->symptom[0], 'dnthc') !== false)
                            checked
                            @endif>
                            <label for="">Dễ nóng tính</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd08" name="symptom[]" value="tucao" type="checkbox" onchange="chkChange('08');" @if (strpos($model->symptom[0], 'tucao') !== false)
                            checked
                            @endif>
                            <label for="">Tự cao</label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd27" name="symptom[]" value="dangtri" type="checkbox" onchange="chkChange('27');" @if (strpos($model->symptom[0], 'dangtri') !== false)
                            checked
                            @endif>
                            <label for="">Đãng trí</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd05" name="symptom[]" value="lthc" type="checkbox" onchange="chkChange('05');" @if (strpos($model->symptom[0], 'lthc') !== false)
                            checked
                            @endif>
                            <label for="">Loạn thần</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd06" name="symptom[]" value="tchc" type="checkbox" onchange="chkChange('06');" @if (strpos($model->symptom[0], 'tchc') !== false)
                            checked
                            @endif>
                            <label for="">Tình cảm</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd09" name="symptom[]" value="hacaohc" type="checkbox" onchange="chkChange('09');" @if (strpos($model->symptom[0], 'hacaohc') !== false)
                            checked
                            @endif>
                            <label for="">Huyết áp cao</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd10" name="symptom[]" value="timmachhc" type="checkbox" onchange="chkChange('10');" @if (strpos($model->symptom[0], 'timmachhc') !== false)
                            checked
                            @endif>
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd18" name="symptom[]" value="tdhc" type="checkbox" onchange="chkChange('18');" @if (strpos($model->symptom[0], 'tdhc') !== false)
                            checked
                            @endif>
                            <label for="">Tình dục</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd18" name="symptom[]" value="thaihc" type="checkbox" onchange="chkChange('19');" @if (strpos($model->symptom[0], 'thaihc') !== false)
                            checked
                            @endif>
                            <label for="">Thai</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd28" name="symptom[]" value="gthd" type="checkbox" onchange="chkChange('28');" @if (strpos($model->symptom[0], 'gthd') !== false)
                            checked
                            @endif>
                            <label for="">Gia tăng hoạt động</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd14" name="symptom[]" value="hvnhhc" type="checkbox" onchange="chkChange('14');" @if (strpos($model->symptom[0], 'hvnhhc') !== false)
                            checked
                            @endif>
                            <label for="">Hành vi nguy hiểm</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd15" name="symptom[]" value="gncn" type="checkbox" onchange="chkChange('15');" @if (strpos($model->symptom[0], 'gncn') !== false)
                            checked
                            @endif>
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" id="kd16" name="symptom[]" value="noinhieu" type="checkbox" onchange="chkChange('16');" @if (strpos($model->symptom[0], 'noinhieu') !== false)
                            checked
                            @endif>
                            <label for="">Nói nhiều</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd11" name="symptom[]" value="parkinson" type="checkbox" onchange="chkChange('11');" @if (strpos($model->symptom[0], 'parkinson') !== false)
                            checked
                            @endif>
                            <label for="">Parkinson</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd12" name="symptom[]" value="dongkinh" type="checkbox" onchange="chkChange('12');" @if (strpos($model->symptom[0], 'dongkinh') !== false)
                            checked
                            @endif>
                            <label for="">Động kinh</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd13" name="symptom[]" value="dtdhc" type="checkbox" onchange="chkChange('13');" @if (strpos($model->symptom[0], 'dtdhc') !== false)
                            checked
                            @endif>
                            <label for="">Đái tháo đường</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="kd17" name="symptom[]" value="beophihc" type="checkbox" onchange="chkChange('17');" @if (strpos($model->symptom[0], 'beophihc') !== false)
                            checked
                            @endif>
