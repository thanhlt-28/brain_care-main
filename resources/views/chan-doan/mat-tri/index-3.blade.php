...
<div class="container-page">
    ...
    <table class="table table-success table-striped table-bordered mt-3 mb-3" border="1" cellspacing="0" cellpadding="2">
        <h3 class="mx-auto mt-3 font-weight-bold">Thuốc Điều Trị Mất Trí</h3>
        <thead>
            <tr>
                <th>STT</th>
                <th>Loại</th>
        ...
        <tbody>
            <tr>
                <th>{{$index++}}</th>
                <td>ĐT MTri</td>
                <td id="dt">ACholineesterase</td>
                <td id="dt">Donepezil</td>
                <td id="dt">Aricept</td>
                <td id="dt">5mg</td>
                <td id="dt">10mg</td>
                <td id="dt">Pfizer</td>
