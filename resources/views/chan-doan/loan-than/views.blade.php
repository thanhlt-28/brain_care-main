                    ...
                    <table class="table">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th>Kết quả</th>
                                <th>
                                    <a href="{{ route('lo-au.create') }}" class="btn btn-success">Thêm chẩn đoán mới</a>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->result }}</td>
                                <td>
                                    <a class="btn btn-info" href="{{route('lo-au.index', $item->id)}}">Xem chi tiết</a>
                                    <a class="btn btn-warning" href="{{route('lo-au.destroy', ['id' => $item->id])}}">Xóa</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
